...
local rmhAddon = false; -- IsAddOnLoaded("RealMobHealth");
local mi2addonaddon = false; -- IsAddOnLoaded("MobInfo2-Classic");
local lortiUIaddon = false; -- IsAddOnLoaded("Lorti-UI-Classic");
